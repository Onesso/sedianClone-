...
import { BODY_IMAGE, DATA_PRELOADER, LAYOUT, LAYOUT_MODE, LAYOUT_POSITION, LAYOUT_WIDTH, SIDEBAR_COLOR, SIDEBAR_VIEW, TOPBAR } from '../layout.model';
...
export class VerticalComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    document.documentElement.setAttribute('data-body-image', BODY_IMAGE);
