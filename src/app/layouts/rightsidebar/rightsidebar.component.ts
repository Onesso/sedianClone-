...
import { LAYOUT, LAYOUT_MODE, LAYOUT_WIDTH, LAYOUT_POSITION, TOPBAR, SIDEBAR_SIZE, SIDEBAR_VIEW, SIDEBAR_COLOR, BODY_IMAGE, DATA_PRELOADER, SIDEBAR_VISIBILITY } from '../layout.model';
