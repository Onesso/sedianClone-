...
import { ApplicationModel } from './acounts-list/accounts-list.model';
import { application } from './acounts-list/data';
import { DecimalPipe } from '@angular/common';
import { debounceTime, delay, switchMap, tap } from 'rxjs/operators';
import { SortColumn, SortDirection } from './acounts-list/application-sortable.directive';
...
export class AccountsListService {
  ...
  getAccountMembers(groupCode: string) {
    const params = { groupCode }
    return this.http.get(
      BASE_URL + 'localAccount/findLocalAccountsListMembers',
      { params }
    );
  }
}
