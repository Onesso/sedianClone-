...
@Component({
  ...
  styleUrls: ['./pending-approval-details.component.scss'],
  providers:[DecimalPipe, SettingsService, ExceptionService]
})
export class PendingApprovalDetailsComponent {
  ...
  getDetails() {
    ...
    this.route.params.subscribe((params) => {
      ...
      this.exceptionQueue = params["queue"];
      let exceptionCategory = this.exceptionQueue;
      this.service
        ...
        .subscribe((resp: any) => {
          switch (resp.messageCode) {
            case "00":
              ...
              this.name = `PENDING ${this.exceptionQueue} EXCEPTION FOR ${this.details[0]?.customerName}`;
              ...
              const item = {
                ...
                caption: caption,
                thumb: thumb ?? "assets/images/logo-sm.png"
              };
              ...
              const FRONTitem = {
                src: FRONTsrc ?? "assets/images/logo-sm.png",
                caption: FRONTcaption ,
                thumb: FRONTthumb ?? "assets/images/logo-sm.png"
              };
              ...
              const BACKitem = {
                src: BACKsrc ?? "assets/images/logo-sm.png",
                caption: BACKcaption,
                thumb: BACKthumb ?? "assets/images/logo-sm.png"
              };
              this.photoImages.push(BACKitem);
               ...
               const SELitem = {
                 src: SELsrc ?? "assets/images/logo-sm.png",
                 caption: SELcaption,
                 thumb: SELthumb ?? "assets/images/logo-sm.png"
               };
              ...
              const IPitem = {
                src: IprsSrc ?? "assets/images/logo-sm.png",
                caption: IPRScaption,
                thumb: IPRSthumb ?? "assets/images/logo-sm.png"
              };             
    ...
    this.service.clearException(payload).subscribe((resp: any) => {
      switch (resp.messageCode) {
        case "00":        
          ...
          this.toastr.success('Application has been approved for this exception');
          setTimeout(() => {
            this.router.navigate(["/app/exception/pedding-approvals"]);
          }, 2000);         
          break;
        case "01":
    ...
    this.service.clearException(payload).subscribe((resp: any) => {
      switch (resp.messageCode) {
        case "00":
          ...
          this.inviteCustomer();
          this.toastr.success('The application has been rejected. Customer has been notified to visit their nearest Sidian branch for help.');
          setTimeout(() => {
            this.router.navigate(["/app/exception/pedding-approvals"]);
          }, 2000);  
          break;
    ...
    this.service.inviteCustomer(payload).subscribe((resp: any) => {
      switch (resp.messageCode) {
        case '00':
          ...
          // this.router.navigate(["/app/exception/kra"]);
          break;
        case '01':
          this.toastr.info(resp.message)
          this.loading = false;
